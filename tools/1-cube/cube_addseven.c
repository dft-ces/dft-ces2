...
main(int argc, char *argv[]){
 ...
 if(argc==8){
  ...
  printf("for cube1+cube2+cube3+cube4+cube5+cube6+cube7, Usage: ./cube_add cube1 cube2 cube3 cube4 cube5 cube6 cube7\n");
  return 0;
 }

 tag_Models base1, base2, base3, base4, base5, base6, base7;
 ...
 for(i=0;i<base1.pGrid[0];i++){
   for(j=0;j<base1.pGrid[1];j++){
     for(k=0;k<base1.pGrid[2];k++){
       base1.pValue[k+j*base1.pGrid[2]+i*base1.pGrid[2]*base1.pGrid[1]] += base2.pValue[k+j*base1.pGrid[2]+i*base1.pGrid[2]*base1.pGrid[1]] + base3.pValue[k+j*base1.pGrid[2]+i*base1.pGrid[2]*base1.pGrid[1]] + base4.pValue[k+j*base1.pGrid[2]+i*base1.pGrid[2]*base1.pGrid[1]] + base5.pValue[k+j*base1.pGrid[2]+i*base1.pGrid[2]*base1.pGrid[1]] + base6.pValue[k+j*base1.pGrid[2]+i*base1.pGrid[2]*base1.pGrid[1]] + base7.pValue[k+j*base1.pGrid[2]+i*base1.pGrid[2]*base1.pGrid[1]];
