...
main(int argc, char *argv[]){
 ...
 if(argc==4){
  ...
  printf("for cube1+cube2+cube3, Usage: ./cube_add cube1 cube2 cube3\n");
  return 0;
 }

 tag_Models base1, base2, base3;
 ...
 for(i=0;i<base1.pGrid[0];i++){
   for(j=0;j<base1.pGrid[1];j++){
     for(k=0;k<base1.pGrid[2];k++){
       base1.pValue[k+j*base1.pGrid[2]+i*base1.pGrid[2]*base1.pGrid[1]] += base2.pValue[k+j*base1.pGrid[2]+i*base1.pGrid[2]*base1.pGrid[1]] + base3.pValue[k+j*base1.pGrid[2]+i*base1.pGrid[2]*base1.pGrid[1]];
     }
   }
 }
