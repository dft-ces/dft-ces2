...
main(int argc, char *argv[]){
 ...
 if(argc==4){
  ...
  printf("Usage: ./dipc chgden.cube dir[x:1|y:2|z:3] position(grid#)\n");
  return 0;
 }
 dir=atoi(argv[2]);
   ...
   for(i=0;i<baseModel.pGrid[0];i++){
     for(j=0;j<baseModel.pGrid[1];j++){
       for(k=0;k<baseModel.pGrid[2];k++){
         if(k < position) {
           sum_below += baseModel.pValue[k+j*baseModel.pGrid[2]+i*baseModel.pGrid[2]*baseModel.pGrid[1]];
         }else{
           sum_over += baseModel.pValue[k+j*baseModel.pGrid[2]+i*baseModel.pGrid[2]*baseModel.pGrid[1]];
         }
       }
     }
   }
 }
 printf("charge density under grid: %f\n charge density over grid: %f\n charge density all grid: %f\n", sum_below*baseModel.cellParams[0]*baseModel.cellParams[1]*baseModel.cellParams[2]/baseModel.pGrid[0]/baseModel.pGrid[1]/baseModel.pGrid[2], sum_over*baseModel.cellParams[0]*baseModel.cellParams[1]*baseModel.cellParams[2]/baseModel.pGrid[0]/baseModel.pGrid[1]/baseModel.pGrid[2],(sum_below+sum_over)*baseModel.cellParams[0]*baseModel.cellParams[1]*baseModel.cellParams[2]/baseModel.pGrid[0]/baseModel.pGrid[1]/baseModel.pGrid[2]);
 //saveCube(baseModel, ".cube");
}//main END
